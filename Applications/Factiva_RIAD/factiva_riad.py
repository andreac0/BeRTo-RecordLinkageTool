...
spark = (
    SparkSession.builder.appName("factiva_riad")
...
country_attribute = 'isocode2'
 ...
 #-------------
# Load data and select all the relevant attributes
dataset2_original = spark.read.parquet('/data/lab/dlb_factiva_news/share/factiva_company_ids_20211130')\
                         .select('isin', 'description', 'code').filter(col('isin').isNotNull())\
                         .withColumn('country', sf.substring(col('isin'),1,2)).drop('isin')\
                         .dropDuplicates()

 # Factiva attribute names

id_data2 = 'code'
name_data2 = 'description'
country_2 = 'country'
street_data2 = 'NA'
city_data2 = 'NA'
pstl_data2 = 'NA'
...
table_name = 'factiva_riad_mapping' # name of the table
