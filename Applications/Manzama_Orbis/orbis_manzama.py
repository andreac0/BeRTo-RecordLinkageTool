...
spark = (
    SparkSession.builder.appName("name_matching_approach")
...
dataset2_original = spark.read.parquet("/data/corporate/gleif/gleif_lei2_cdf_public_records/")\
                         .select('lei', 'legal_name', 'la_country').dropDuplicates()
...
disc_lab = 'lab_prj_sds' # only data lab allowed, no corporate store
table_name = 'riad_glief_mapping' # name of the table
